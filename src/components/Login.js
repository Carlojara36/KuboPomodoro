...
function Login(){
    ...
    return (
      <div className="flex h-full flex-row justify-center mt-24">
        <div className="lg:flex md:flex sm:inline-block lg:-space-x-1 md:-space-x-1">
          
          <div className=" lg:rounded-l-3xl px-4 lg:px-24 py-16 lg:max-w-xl sm:max-w-md w-full h-full bg-[#EB3C27]"> 
