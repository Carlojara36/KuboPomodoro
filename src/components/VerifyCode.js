                ...
                <div className=" flex flex-col m-auto rounded-r-3xl  lg:px-16 py-16 lg:max-w-xl sm:max-w-md w-full h-full bg-gray-300 " >
                    ...
                    <form className='mt-12 justify-center -space-y'>
                        <div className="rounded-md shadow-sm -space-y-px mr-6 ml-6">
                            ...
                            <div>
                                <button type="button" id="verify-login" className="w-full justify-center my-2 text-white bg-[#087830] hover:bg-white hover:text-black font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 mt-6 mb-2" onClick={handleVerify}>
                                    Verify
                                </button>
